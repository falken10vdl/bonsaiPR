...
SCRIPTS_SOURCE_DIR = "/home/falken10vdl/bonsaiPRDevel/weekly-bonsaipr-automation"
...
def sanitize_script_content(content):
    ...
    # Remove GitHub token
    content = re.sub(r'GITHUB_TOKEN = "[^"]*"', 'GITHUB_TOKEN = "YOUR_GITHUB_TOKEN_HERE"', content)
    
    # Remove GitHub owner (make it configurable)
    content = re.sub(r'GITHUB_OWNER = "falken10vdl"', 'GITHUB_OWNER = "YOUR_GITHUB_USERNAME"', content)
    
    # Remove any hardcoded paths that might be specific to this system
    content = re.sub(r'/home/falken10vdl/', '/path/to/your/', content)
